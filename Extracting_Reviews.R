...
# Amazon Reviews #############################
aurl <- "https://www.amazon.in/Apple-iPhone-11-64GB-Purple/dp/B07XVL4P83/ref=pd_rhf_gw_p_img_5?_encoding=UTF8&psc=1&refRID=X52ZNDRG62N4RK1X0MKA#customerReviews"
amazon_reviews <- NULL
for (i in 1:30){
